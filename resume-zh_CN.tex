...
\contactInfo{(+86) 189-2640-7195}{1571276740@qq.com}{IC设计工程师}{GitHub @LANEYEovo}
% {E-mail}{mobilephone}
% keep the last empty braces!
%\contactInfo{xxx@yuanbin.me}{(+86) 131-221-87xxx}{}
 
\section{个人总结}
本人在校成绩优秀、乐观向上，工作负责、自我驱动力强、热爱尝试新事物，认同开放、连接、共享的Web在未来的不可替代性。在校期间长期从事数字IC设计相关研究，对IC技术发展趋势及前端工程化解决方案有浓厚兴趣。\textbf{}

% \section{\faGraduationCap\ 教育背景}
\section{教育背景}
\datedsubsection{\textbf{哈尔滨理工大学},集成电路设计与集成系统,\textit{在读大学生}}{2019.9 - 至今}
\ \textbf{排名11/133(前10\%)},IEEE Student member,预计2023年6月毕业
